...
<div class="doc-content">
  ...
  <div class="doc-section">
    ...
    <p style="background: #FEF3C7; border: 1px solid #F59E0B; border-radius: 6px; padding: 10px 14px; font-size: 13px; color: #78350F; margin-bottom: 16px;">
      <strong>&#x26A0;&#xFE0F; <code>validate</code> moved to <code>@no-js-dev/nojs-elements</code></strong> as of v1.13.0. Core stubs emit deprecation warnings. <a href="#/docs/plugins" style="color: #92400E; font-weight: 600;">Migration Guide &rarr;</a>
    </p>
    <table class="doc-table">
  ...
  <div class="doc-section">
    ...
    <p style="background: #FEF3C7; border: 1px solid #F59E0B; border-radius: 6px; padding: 10px 14px; font-size: 13px; color: #78350F; margin-bottom: 16px;">
      <strong>&#x26A0;&#xFE0F; Moved to <code>@no-js-dev/nojs-elements</code></strong> as of v1.13.0. Core stubs emit deprecation warnings. <a href="#/docs/plugins" style="color: #92400E; font-weight: 600;">Migration Guide &rarr;</a>
    </p>
    <table class="doc-table">
